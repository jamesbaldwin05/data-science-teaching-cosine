...
3. [Customising Plots](#customising-plots)
    - [Titles and Labels](#titles-and-labels)
    - [Legends](#legends)
    - [Ticks](#ticks)
    - [Limits](#limits)
    - [Colours, Linestyles, Markers](#colours-linestyles-markers)
    - [Change figure size](#change-figure-size)
4. [Saving Figures](#saving-figures)
5. [Subplots and Multiple Plots](#subplots-and-multiple-plots)
...
They can also be passed as one shorthand parameter for the same result. For example, `plt.plot([1, 2, 3], [4, 5, 6], 'ro--')` for the above example (r for red colour, o for o marker and -- for linestyle).
